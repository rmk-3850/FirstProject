            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li id="customer-li" class="sidebar-item has-sub">
                        ...
                        <li id="reservation-li" class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
                        ...
                        <li id="service-li" class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
                        ...
                        <li id="product-li" class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
                        ...
                        <li id="member-li" class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
                        ...
                        <li id="notice-li" class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link'>
