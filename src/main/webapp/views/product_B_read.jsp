	        ...
	        <div id="main">
	            ...
	            <div class="page-heading">
	                ...
	                <%
		            	...
		            	ProductDTO board = prodDAO.getProductBOne(pd_B_code);
	                %>
                    <form method="post" action="product_B_delete.jsp" id="">
                        <div class="row" id="table-hover-row">
                            <div class="col-lg-12 mb-12">
                                <div class="input-group mb-12">
                                    <span class="input-group-text" id="basic-addon1">상품 코드</span>
                                    <input type="text" class="form-control" name="pd_B_code" value="<%=board.getPd_B_code() %>">
                                </div>
                            </div>
                            <br><br><br>
                            <div class="col-lg-12 mb-12">
                            ...
                            <div class="button-container">
                                <button type="submit" onclick="삭제되었습니다.">삭제</button>
