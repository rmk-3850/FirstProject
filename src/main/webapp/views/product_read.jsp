	        ...
	        <div id="main">
	            ...
	            <div class="page-heading">
	                ...
	                <%
		            	...
		            	board = prodDAO.getProductOne(pd_B_code, pd_code);
	                %>
                    <form method="post" action="product_read_action.jsp" id="">
                        ...
                        <div class="row" id="table-hover-row">
                            <div class="col-lg-12 mb-12">
                                <div class="input-group mb-12">
                                    ...
                                    <input type="text" class="form-control" name="pd_code" value="<%=board.getPd_code() %>" readonly="readonly">
                                </div>
                            </div>
                            <br><br><br>
                            <div class="col-lg-12 mb-12">
